 ...
 */
public class page_4 extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mSwipeRefreshLayout = getView().findViewById(R.id.page_4_swipeRefreshLayout);
...
//        Picasso.get().load("http://developer.android.com/assets/images/android_logo.png").into(imageView);
        ...
        recyclerView = getView().findViewById(R.id.page_4_recyclerView);
    ...
    public static page_4 newInsance(){
