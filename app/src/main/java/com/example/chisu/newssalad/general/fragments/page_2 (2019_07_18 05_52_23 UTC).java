 ...
 */
public class page_2 extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public static page_2 newInsance(){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mSwipeRefreshLayout = getView().findViewById(R.id.page_2_swipeRefreshLayout);
...
//        Picasso.get().load("http://developer.android.com/assets/images/android_logo.png").into(imageView);
        ...
        recyclerView = getView().findViewById(R.id.page_2_recyclerView);
        adapter = new VodListAdapter(recyclerItemList, getView().getContext());
