...
public class HomeActivity extends DrawerActivity {
    ...
    //이더리움 테스트넷과 연결하기 위한 web3j 클라이언트
    Web3j web3j;
    ...
    //특정 TokenItem을 여러 곳에서 사용하기 위해 전역 변수로 설정.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addProfile(
                new DrawerProfile()
                        .setRoundedAvatar((BitmapDrawable) getResources().getDrawable(R.drawable.baseline_adb_black_48))
        ...
        addItem(
                drawerTokenItem = new DrawerItem()
                        .setImage(getResources().getDrawable(R.drawable.baseline_monetization_on_black_36))
...
//        addDivider();
        addItem(
                new DrawerItem()
                        .setImage(getResources().getDrawable(R.drawable.baseline_local_atm_black_48))
        ...
        addItem(
                new DrawerItem()
                        .setImage(getResources().getDrawable(R.drawable.baseline_record_voice_over_black_48))
                        .setTextPrimary("방송하기")
                        .setOnItemClickListener(new DrawerItem.OnItemClickListener() {
                            @Override
                            public void onClick(DrawerItem drawerItem, long id, int position) {
...
//        );
        addItem(
                new DrawerItem()
                        .setImage(getResources().getDrawable(R.drawable.baseline_camera_front_black_48))
                        .setTextPrimary("모자이크")
                        .setOnItemClickListener(new DrawerItem.OnItemClickListener() {
                            @Override
                            public void onClick(DrawerItem drawerItem, long id, int position) {
    ...
    protected void onResume() {
        ...
        logManager = LogManager.getLogManagerInstance(HomeActivity.this);
